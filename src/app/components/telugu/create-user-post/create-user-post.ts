...
export class CreateUserPost {
  ...
  // Get 'te' or 'en' directly from current URL route
  get currentRouteLanguage(): string {
    ...
    return firstSegment === 'te' ? 'Telugu' : 'English';
  }
  userLanguage: any = '';
  userType: any = '';
  mediaApiUrl: any = '';
  ...
  //     // Make HTTP request using Angular's HttpClient converted to Promise
  //     const res:any = await firstValueFrom(
  //       // this.http.post<any>(`${this.apiUrl}api/upload_parallel`, formData),
  //       this.service.uploadAWSMedia(formData),
  //     );

  //     let fileLink = res.data;
  //     console.log('file link: ', res.data);
